...
default['pantry']['ssh_key_name'] = 'aws-eu-west-1.pem'

# Data Bag Item
default['pantry']['aws']['queue_name'] = 'pantry_example_com-ec2_boot_command'
default['pantry']['aws']['access_key_id'] = 'AKIEXAMPLEACCESSKEYA'
...
default['pantry']['aws']['key_pair_name'] = 'aws-eu-west-1'
...
default['pantry']['pantry']['default_ou'] = 'OU=Computers,DC=example,DC=come'
